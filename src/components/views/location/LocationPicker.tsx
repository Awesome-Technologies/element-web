...
import { tileServerFromWellKnown } from "matrix-react-sdk/src/utils/WellKnownUtils";
import { GenericPosition, genericPositionFromGeolocation, getGeoUri } from "matrix-react-sdk/src/utils/beacon";
import { LocationShareError, findMapStyleUrl, positionFailureMessage } from "matrix-react-sdk/src/utils/location";
import ErrorDialog from "matrix-react-sdk/src/components/views/dialogs/ErrorDialog";
import AccessibleButton from "matrix-react-sdk/src/components/views/elements/AccessibleButton";
import { MapError } from "matrix-react-sdk/src/components/views/location/MapError";
import LiveDurationDropdown, {
    DEFAULT_DURATION_MS,
} from "matrix-react-sdk/src/components/views/location/LiveDurationDropdown";
import { LocationShareType, ShareLocationFn } from "matrix-react-sdk/src/components/views/location/shareLocation";
import Marker from "matrix-react-sdk/src/components/views/location/Marker";
...
class LocationPicker extends React.Component<ILocationPickerProps, IState> {
    ...
    public componentDidMount(): void {
        ...
        try {
            ...
            // do not add geolocate control to the map
