...
// ORIGINAL CODE
// https://github.com/element-hq/matrix-react-sdk/blob/v3.113.0/src/components/views/location/shareLocation.ts
// ORIGINAL PATH
...
import QuestionDialog, { IQuestionDialogProps } from "matrix-react-sdk/src/components/views/dialogs/QuestionDialog";
import SdkConfig from "matrix-react-sdk/src/SdkConfig";
import { OwnBeaconStore } from "matrix-react-sdk/src/stores/OwnBeaconStore";
...
const getDefaultErrorParams = (
    ...
    const modalParams = {
        ...
        onFinished: (tryAgain: boolean): void => {
            if (tryAgain) {
                openMenu();
            }
        },
