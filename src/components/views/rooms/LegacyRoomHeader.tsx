...
// ORIGINAL CODE
// https://github.com/element-hq/matrix-react-sdk/blob/v3.113.0/src/components/views/rooms/LegacyRoomHeader.tsx
// ORIGINAL PATH
...
import RoomContextMenu from "matrix-react-sdk/src/components/views/context_menus/RoomContextMenu";
import { contextMenuBelow } from "matrix-react-sdk/src/components/views/rooms/RoomTile";
...
import { NotificationStateEvents } from "matrix-react-sdk/src/stores/notifications/NotificationState";
import RoomContext from "matrix-react-sdk/src/contexts/RoomContext";
import RoomLiveShareWarning from "matrix-react-sdk/src/components/views/beacon/RoomLiveShareWarning";
...
import { useWidgets } from "matrix-react-sdk/src/utils/WidgetUtils";
import { WidgetType } from "matrix-react-sdk/src/widgets/WidgetType";
import { useCall, useLayout } from "matrix-react-sdk/src/hooks/useCall";
import { getJoinedNonFunctionalMembers } from "matrix-react-sdk/src/utils/room/getJoinedNonFunctionalMembers";
import { Call, ElementCall, Layout } from "matrix-react-sdk/src/models/Call";
...
import { SessionDuration } from "matrix-react-sdk/src/components/views/voip/CallDuration";
import RoomCallBanner from "matrix-react-sdk/src/components/views/beacon/RoomCallBanner";
...
import { SearchInfo } from "matrix-react-sdk/src/Searching";
...
export default class RoomHeader extends React.Component<IProps, IState> {
    ...
    public render(): React.ReactNode {
        ...
        // show a warning if the room is unencrypted
        const unencryptedWarning =
            !this.client.isRoomEncrypted(this.props.room.roomId) && this.client.isCryptoEnabled() ? (
                <div style={{ position: "relative", flex: 1, right: "35%" }}>
                    <span className={classNames("mx_E2EIcon_warning")} />
                    <span style={{ left: "55%", position: "relative", fontWeight: 600 }}>
                        {_t("End-to-end encryption isn't enabled")}
                    </span>
                </div>
            ) : null;
