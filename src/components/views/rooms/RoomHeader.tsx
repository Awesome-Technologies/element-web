...
// ORIGINAL CODE
// https://github.com/element-hq/matrix-react-sdk/blob/v3.113.0/src/components/views/rooms/RoomHeader.tsx
// ORIGINAL PATH
...
import { useRoomName } from "matrix-react-sdk/src/hooks/useRoomName";
import { RightPanelPhases } from "matrix-react-sdk/src/stores/right-panel/RightPanelStorePhases";
import { useMatrixClientContext } from "matrix-react-sdk/src/contexts/MatrixClientContext";
import { useRoomMemberCount, useRoomMembers } from "matrix-react-sdk/src/hooks/useRoomMembers";
import { _t } from "matrix-react-sdk/src/languageHandler";
import { Flex } from "matrix-react-sdk/src/components/utils/Flex";
import { Box } from "matrix-react-sdk/src/components/utils/Box";
import { getPlatformCallTypeLabel, useRoomCall } from "matrix-react-sdk/src/hooks/room/useRoomCall";
import { useRoomThreadNotifications } from "matrix-react-sdk/src/hooks/room/useRoomThreadNotifications";
import { useGlobalNotificationState } from "matrix-react-sdk/src/hooks/useGlobalNotificationState";
import SdkConfig from "matrix-react-sdk/src/SdkConfig";
import { useFeatureEnabled, useSettingValue } from "matrix-react-sdk/src/hooks/useSettings";
import { useEncryptionStatus } from "matrix-react-sdk/src/hooks/useEncryptionStatus";
import { E2EStatus } from "matrix-react-sdk/src/utils/ShieldUtils";
import FacePile from "matrix-react-sdk/src/components/views/elements/FacePile";
...
import { formatCount } from "matrix-react-sdk/src/utils/FormattingUtils";
...
import { VideoRoomChatButton } from "matrix-react-sdk/src/components/views/rooms/RoomHeader/VideoRoomChatButton";
import { RoomKnocksBar } from "matrix-react-sdk/src/components/views/rooms/RoomKnocksBar";
import { isVideoRoom as calcIsVideoRoom } from "matrix-react-sdk/src/utils/video-rooms";
import { notificationLevelToIndicator } from "matrix-react-sdk/src/utils/notifications";
import { CallGuestLinkButton } from "matrix-react-sdk/src/components/views/rooms/RoomHeader/CallGuestLinkButton";
import { ButtonEvent } from "matrix-react-sdk/src/components/views/elements/AccessibleButton";
import WithPresenceIndicator, {
    useDmMember,
} from "matrix-react-sdk/src/components/views/avatars/WithPresenceIndicator";
...
import { MainSplitContentType } from "matrix-react-sdk/src/components/structures/RoomView";
import defaultDispatcher from "matrix-react-sdk/src/dispatcher/dispatcher.ts";
import { RoomSettingsTab } from "matrix-react-sdk/src/components/views/dialogs/RoomSettingsDialog.tsx";
...
export default function RoomHeader({
    ...
    const isEncrypted: boolean = client.isRoomEncrypted(room.roomId);
    ...
    if (!showVideoCallButton || !showButtons) {
        videoCallButton = undefined;
    }
    if (!showVoiceCallButton || !showButtons) {
                ...
                >
                    <Box flex="1" className="mx_RoomHeader_info">
                        ...
                        >
                            ...
                            {!isEncrypted && (
                                <div style={{ position: "relative", flex: 1, right: "35%" }}>
                                    <span className="mx_E2EIcon_warning" />
                                    <span style={{ left: "55%", position: "relative", fontWeight: 600 }}>
                                        {_t("tim|security|warning_unencrypted")}
                                    </span>
                                </div>
                            )}
                        </BodyText>
