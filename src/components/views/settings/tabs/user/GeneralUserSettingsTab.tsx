...
// ORIGINAL CODE
// https://github.com/matrix-org/matrix-react-sdk/blob/v3.79.0/src/components/views/settings/tabs/user/GeneralUserSettingsTab.tsx
// ORIGINAL PATH
...
import { Service, ServicePolicyPair, startTermsFlow } from "matrix-react-sdk/src/Terms";
...
export default class GeneralUserSettingsTab extends React.Component<IProps, IState> {
    ...
    // allows configuring a timespan after which rooms are suggested for deletion
    private renderAutoDeletionSection(): JSX.Element {
        return (
            <SettingsSubsection
                heading={_t("Automatic deletion of rooms")}
                description={_t("Timespan after which inactive rooms are suggested for deletion")}
                stretchContent
            >
                <Field
                    label={_t("Timespan of inactivity of a room (days)")}
                    type="number"
        ...
        return (
            <SettingsTab data-testid="mx_GeneralUserSettingsTab">
                <SettingsSection heading={_t("General")}>
                    ...
                    {this.renderAutoDeletionSection()}
                </SettingsSection>
                {discoverySection}
