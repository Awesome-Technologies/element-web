...
async function cacheDownloadIcon(): Promise<void> {
    ...
    const svg = await fetch(require("matrix-react-sdk/res/img/download.svg").default).then((r) => r.text());
...
export default class MFileBody extends React.Component<IProps, IState> {
    ...
    private onPlaceholderClick = async (consent: boolean): Promise<void> => {
        if (!consent) return;
