...
// ORIGINAL CODE
// https://github.com/element-hq/matrix-react-sdk/blob/v3.113.0/src/components/views/dialogs/ExportDialog.tsx
// ORIGINAL PATH
...
import { validateNumberInRange } from "matrix-react-sdk/src/utils/validate";
...
const ExportDialog: React.FC<IProps> = ({ room, onFinished }) => {
    ...
    const validateSize = withValidation({
        rules: [
            {
                key: "required",
                test({ value, allowEmpty }): boolean | Promise<boolean> {
    ...
    if (exportCancelled) {
        ...
        return (
            ...
            >
                ...
                <DialogButtons
                    ...
                    onCancel={(): void => setCancelWarning(false)}
        ...
        return (
            ...
            >
                ...
                {!isExporting ? <p>{_t("tim|security|export_data")}</p> : null}
                    ...
                    {!!setExportFormat && (
                        <>
                            ...
                            <StyledRadioGroup
                                name="exportFormat"
                                value={exportFormat}
                                onChange={(key: ExportFormatKey): void => setExportFormat(ExportFormat[key])}
                    ...
                    {setSizeLimit && (
                        <>
                            ...
                            <Field
                                ...
                                onChange={(e): void => setSizeLimit(parseInt(e.target.value))}
                            />
                        </>
                    )}
                    ...
                    {setAttachments && (
                        <>
                            <StyledCheckbox
                                ...
                                onChange={(e): void => setAttachments((e.target as HTMLInputElement).checked)}
                            >
                ...
                {isExporting ? (
                    ...
                    <DialogButtons
                        ...
                        onCancel={(): void => onFinished(false)}
                    />
                )}
            </BaseDialog>
        );
