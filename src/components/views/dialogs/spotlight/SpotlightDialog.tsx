...
// ORIGINAL CODE
// https://github.com/matrix-org/matrix-react-sdk/blob/v3.79.0/src/components/views/dialogs/spotlight/SpotlightDialog.tsx
// ORIGINAL PATH
            ...
            hiddenResultsSection = (
                <div className="mx_SpotlightDialog_section mx_SpotlightDialog_hiddenResults" role="group">
                    ...
                    <TooltipOption
                        ...
                        onHideTooltip={(): void => setInviteLinkCopied(false)}
