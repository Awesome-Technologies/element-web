...
// ORIGINAL CODE
// https://github.com/element-hq/matrix-react-sdk/blob/v3.113.0/src/components/views/dialogs/spotlight/SpotlightDialog.tsx
// ORIGINAL PATH
// matrix-react-sdk/src/components/views/dialogs/spotlight/
...
import { useDebouncedCallback } from "matrix-react-sdk/src/hooks/spotlight/useDebouncedCallback";
import { useRecentSearches } from "matrix-react-sdk/src/hooks/spotlight/useRecentSearches";
import { useProfileInfo } from "matrix-react-sdk/src/hooks/useProfileInfo";
import { usePublicRoomDirectory } from "matrix-react-sdk/src/hooks/usePublicRoomDirectory";
import { useSpaceResults } from "matrix-react-sdk/src/hooks/useSpaceResults";
import { useUserDirectory } from "matrix-react-sdk/src/hooks/useUserDirectory";
...
import { showStartChatInviteDialog } from "matrix-react-sdk/src/RoomInvite";
...
import { RecentAlgorithm } from "matrix-react-sdk/src/stores/room-list/algorithms/tag-sorting/RecentAlgorithm";
import { SdkContextClass } from "matrix-react-sdk/src/contexts/SDKContext";
import { getMetaSpaceName } from "matrix-react-sdk/src/stores/spaces";
import SpaceStore from "matrix-react-sdk/src/stores/spaces/SpaceStore";
import { DirectoryMember, Member, startDmOnFirstMessage } from "matrix-react-sdk/src/utils/direct-messages";
import DMRoomMap from "matrix-react-sdk/src/utils/DMRoomMap";
import { makeUserPermalink } from "matrix-react-sdk/src/utils/permalinks/Permalinks";
...
import { Option } from "matrix-react-sdk/src/components/views/dialogs/spotlight/Option";
import { PublicRoomResultDetails } from "matrix-react-sdk/src/components/views/dialogs/spotlight/PublicRoomResultDetails";
import { RoomResultContextMenus } from "matrix-react-sdk/src/components/views/dialogs/spotlight/RoomResultContextMenus";
import { RoomContextDetails } from "matrix-react-sdk/src/components/views/rooms/RoomContextDetails";
import { TooltipOption } from "matrix-react-sdk/src/components/views/dialogs/spotlight/TooltipOption";
                ...
                <div>
                    {filter !== Filter.PublicSpaces && supportsSpaceFiltering && (
                        <Option
                            ...
                            onClick={(): void => setFilter(Filter.PublicSpaces)}
                        >
                    ...
                    {filter !== Filter.PublicRooms && (
                        <Option
                            ...
                            onClick={(): void => setFilter(Filter.PublicRooms)}
                        >
                    ...
                    {filter !== Filter.People && (
                        <Option
                            ...
                            onClick={(): void => setFilter(Filter.People)}
                        >
            ...
            groupChatSection = (
                ...
                >
                    ...
                    <Option
                        ...
                        onClick={(): void => showStartChatInviteDialog(trimmedQuery)}
                    >
                ...
                >
                    {filter === Filter.PublicRooms && (
                        <div style={{ marginBottom: "10px" }}>
                            ...
                            />
                            <span style={{ marginLeft: "25px" }}>{_t("tim|security|warning_public")}</span>
                            <br />
                        </div>
                    )}
                    {content}
...
const RovingSpotlightDialog: React.FC<IProps> = (props) => {
    return <RovingTabIndexProvider>{(): ReactElement => <SpotlightDialog {...props} />}</RovingTabIndexProvider>;
};
