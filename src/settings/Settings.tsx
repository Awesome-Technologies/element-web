...
// ORIGINAL CODE
// https://github.com/element-hq/matrix-react-sdk/blob/v3.113.0/src/settings/Settings.tsx
// ORIGINAL PATH
// matrix-react-sdk/src/settings/
import React, { ReactNode } from "react";
import { UNSTABLE_MSC4133_EXTENDED_PROFILES } from "matrix-js-sdk/src/matrix";
import { _t, _td, TranslationKey } from "matrix-react-sdk/src/languageHandler";
import DeviceIsolationModeController from "matrix-react-sdk/src/settings/controllers/DeviceIsolationModeController.ts";
import {
    NotificationBodyEnabledController,
    NotificationsEnabledController,
} from "matrix-react-sdk/src/settings/controllers/NotificationControllers";
import ThemeController from "matrix-react-sdk/src/settings/controllers/ThemeController";
import ReloadOnChangeController from "matrix-react-sdk/src/settings/controllers/ReloadOnChangeController";
import FontSizeController from "matrix-react-sdk/src/settings/controllers/FontSizeController";
import SystemFontController from "matrix-react-sdk/src/settings/controllers/SystemFontController";
import { SettingLevel } from "matrix-react-sdk/src/settings/SettingLevel";
import SettingController from "matrix-react-sdk/src/settings/controllers/SettingController";
import { IS_MAC } from "matrix-react-sdk/src/Keyboard";
import UIFeatureController from "matrix-react-sdk/src/settings/controllers/UIFeatureController";
...
import ReducedMotionController from "matrix-react-sdk/src/settings/controllers/ReducedMotionController";
import IncompatibleController from "matrix-react-sdk/src/settings/controllers/IncompatibleController";
import { ImageSize } from "matrix-react-sdk/src/settings/enums/ImageSize";
import { MetaSpace } from "matrix-react-sdk/src/stores/spaces";
import SdkConfig from "matrix-react-sdk/src/SdkConfig";
import SlidingSyncController from "matrix-react-sdk/src/settings/controllers/SlidingSyncController";
import { FontWatcher } from "matrix-react-sdk/src/settings/watchers/FontWatcher";
import ServerSupportUnstableFeatureController from "matrix-react-sdk/src/settings/controllers/ServerSupportUnstableFeatureController";
import { WatchManager } from "matrix-react-sdk/src/settings/WatchManager";
import { CustomTheme } from "matrix-react-sdk/src/theme";
import AnalyticsController from "matrix-react-sdk/src/settings/controllers/AnalyticsController";
...
export const SETTINGS: { [setting: string]: ISetting } = {
    "feature_video_rooms": {
        ...
        betaInfo: {
            ...
            image: require("matrix-react-sdk/res/img/betas/video_rooms.png"),
    ...
    "inactivityTimeOnLock": {
        supportedLevels: [SettingLevel.DEVICE],
        displayName: _td("tim|settings|inactivity_time"),
        default: 60,
    },
    "roomInactivityTimespan": {
        supportedLevels: [SettingLevel.DEVICE],
        displayName: _td("tim|settings|auto_deletion_time"),
        default: 180,
    },
    "sendPresence": {
        supportedLevels: LEVELS_ACCOUNT_SETTINGS,
        displayName: _td("tim|settings|send_presence"),
        default: false,
    },
};
