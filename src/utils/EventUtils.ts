...
import { launchPollEditor } from "matrix-react-sdk/src/components/views/messages/MPollBody";
import { Action } from "matrix-react-sdk/src/dispatcher/actions";
import { ViewRoomPayload } from "matrix-react-sdk/src/dispatcher/payloads/ViewRoomPayload";
import { VoiceBroadcastInfoEventType, VoiceBroadcastInfoState } from "matrix-react-sdk/src/voice-broadcast/types";
...
export function canEditContent(matrixClient: MatrixClient, mxEvent: MatrixEvent): boolean {
    // prevent editing messages as gematik forbids it according to the incompatibility with Matrix 1.3
    // m.replace was introduced in Matrix 1.4
    return false;
