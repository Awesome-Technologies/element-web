...
// ORIGINAL CODE
// https://github.com/element-hq/matrix-react-sdk/blob/v3.113.0/src/utils/AutoDiscoveryUtils.tsx
// ORIGINAL PATH
...
import { _t, _td, TranslationKey, UserFriendlyError } from "matrix-react-sdk/src/languageHandler";
...
export default class AutoDiscoveryUtils {
    ...
    public static async buildValidatedConfigFromDiscovery(
        ...
        try {
            ...
            // AMP.tim: also support http 400 as Synapse 1.69.0 sends a 400 instead of 404
            if (
                e instanceof MatrixError &&
                (e.httpStatus === 400 || e.httpStatus === 404) &&
